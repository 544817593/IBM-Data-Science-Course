...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        class_counts = spacex_df['Launch Site'].value_counts().reset_index()
        class_counts.columns = ['Launch Site', 'count']
        ...
        class_counts['class'] = class_counts['class'].map({1: 'Success', 0: 'Failed'})
